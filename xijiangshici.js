...
[rewrite_local]
^https?:\/\/api\.revenuecat\.com\/v1\/(subscribers\/[^\/]+$|receipts$) url script-response-body https://raw.githubusercontent.com/Guding88/Script/main/xijiangshici.js
^https?:\/\/api\.revenuecat\.com\/v1\/(subscribers\/[^\/]+$|receipts$) url script-request-header https://raw.githubusercontent.com/Guding88/Script/main/xijiangshici.js
...
if (typeof $response == "undefined") {
  ...
  const app = 'gd';const list = {'gd':{name: 'Pro Lifetime', id: 'com.uzero.poem.life1.free'}};
  const data = {
